...
export class Operator_v2__VERSIONResult {
  value0: i32;
  value1: i32;
...
export class Operator_v2__configResultValue0Struct extends ethereum.Tuple {
...
export class Operator_v2__requestPermissionsResultRequestsStruct extends ethereum.Tuple {
  get keycode(): Bytes {
...
export class Operator_v2__statusResultValue0Struct extends ethereum.Tuple {
  get low(): Operator_v2__statusResultValue0LowStruct {
    return changetype<Operator_v2__statusResultValue0LowStruct>(
      this[0].toTuple(),
    );
  }

  get high(): Operator_v2__statusResultValue0HighStruct {
    return changetype<Operator_v2__statusResultValue0HighStruct>(
      this[1].toTuple(),
    );
  }
}

export class Operator_v2__statusResultValue0LowStruct extends ethereum.Tuple {
  get count(): BigInt {
    return this[0].toBigInt();
  }
...
export class Operator_v2__statusResultValue0HighStruct extends ethereum.Tuple {
  get count(): BigInt {
    return this[0].toBigInt();
  }
...
export class Operator_v2 extends ethereum.SmartContract {
  static bind(address: Address): Operator_v2 {
    return new Operator_v2("Operator_v2", address);
  }
  ...
  VERSION(): Operator_v2__VERSIONResult {
    const result = super.call("VERSION", "VERSION():(uint8,uint8)", []);

    return new Operator_v2__VERSIONResult(result[0].toI32(), result[1].toI32());
  }

  try_VERSION(): ethereum.CallResult<Operator_v2__VERSIONResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Operator_v2__VERSIONResult(value[0].toI32(), value[1].toI32()),
    );
  }

  _ohm(): Address {
    const result = super.call("_ohm", "_ohm():(address)", []);

    return result[0].toAddress();
  }

  try__ohm(): ethereum.CallResult<Address> {
    const result = super.tryCall("_ohm", "_ohm():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  _reserve(): Address {
    const result = super.call("_reserve", "_reserve():(address)", []);

    return result[0].toAddress();
  }

  try__reserve(): ethereum.CallResult<Address> {
    const result = super.tryCall("_reserve", "_reserve():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  try__wrappedReserve(): ethereum.CallResult<Address> {
  ...
  appraiser(): Address {
    const result = super.call("appraiser", "appraiser():(address)", []);

    return result[0].toAddress();
  }

  try_appraiser(): ethereum.CallResult<Address> {
    const result = super.tryCall("appraiser", "appraiser():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  config(): Operator_v2__configResultValue0Struct {
    const result = super.call(
      "config",
    ...
    return changetype<Operator_v2__configResultValue0Struct>(
      result[0].toTuple(),
    );
  }

  try_config(): ethereum.CallResult<Operator_v2__configResultValue0Struct> {
    const result = super.tryCall(
      "config",
      "config():((uint32,uint32,uint32,uint32,uint32,uint32,uint32,uint32))",
      [],
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Operator_v2__configResultValue0Struct>(value[0].toTuple()),
    );
  }
  ...
  manualTargetPrice(): BigInt {
    const result = super.call(
      "manualTargetPrice",
      "manualTargetPrice():(uint256)",
      [],
    );
  ...
  try_manualTargetPrice(): ethereum.CallResult<BigInt> {
    const result = super.tryCall(
      "manualTargetPrice",
      "manualTargetPrice():(uint256)",
      [],
  ...
  requestPermissions(): Array<Operator_v2__requestPermissionsResultRequestsStruct> {
    const result = super.call(
      "requestPermissions",
    ...
    return result[0].toTupleArray<Operator_v2__requestPermissionsResultRequestsStruct>();
  }

  try_requestPermissions(): ethereum.CallResult<
    Array<Operator_v2__requestPermissionsResultRequestsStruct>
  > {
    const result = super.tryCall(
      "requestPermissions",
      "requestPermissions():((bytes5,bytes4)[])",
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Operator_v2__requestPermissionsResultRequestsStruct>(),
    );
  }
  ...
  status(): Operator_v2__statusResultValue0Struct {
    const result = super.call(
      "status",
    ...
    return changetype<Operator_v2__statusResultValue0Struct>(
      result[0].toTuple(),
    );
  }

  try_status(): ethereum.CallResult<Operator_v2__statusResultValue0Struct> {
    const result = super.tryCall(
      "status",
      "status():(((uint32,uint48,uint32,bool[]),(uint32,uint48,uint32,bool[])))",
      [],
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Operator_v2__statusResultValue0Struct>(value[0].toTuple()),
    );
  }
