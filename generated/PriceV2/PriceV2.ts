...
export class PriceV2__VERSIONResult {
  value0: i32;
  value1: i32;
...
export class PriceV2__getAssetDataResultValue0Struct extends ethereum.Tuple {
...
export class PriceV2__getPriceResult {
  value0: BigInt;
  value1: BigInt;
...
export class PriceV2__getPriceIn2Result {
  value0: BigInt;
  value1: BigInt;
...
export class PriceV2 extends ethereum.SmartContract {
  static bind(address: Address): PriceV2 {
    return new PriceV2("PriceV2", address);
  }
  ...
  VERSION(): PriceV2__VERSIONResult {
    const result = super.call("VERSION", "VERSION():(uint8,uint8)", []);

    return new PriceV2__VERSIONResult(result[0].toI32(), result[1].toI32());
  }

  try_VERSION(): ethereum.CallResult<PriceV2__VERSIONResult> {
    ...
    return ethereum.CallResult.fromValue(
      new PriceV2__VERSIONResult(value[0].toI32(), value[1].toI32()),
    );
  }
  ...
  getAssetData(asset_: Address): PriceV2__getAssetDataResultValue0Struct {
    const result = super.call(
      "getAssetData",
    ...
    return changetype<PriceV2__getAssetDataResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getAssetData(
    asset_: Address,
  ): ethereum.CallResult<PriceV2__getAssetDataResultValue0Struct> {
    const result = super.tryCall(
      "getAssetData",
      "getAssetData(address):((bool,bool,bool,uint32,uint16,uint16,uint48,uint256,uint256[],bytes,bytes))",
      [ethereum.Value.fromAddress(asset_)],
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<PriceV2__getAssetDataResultValue0Struct>(value[0].toTuple()),
    );
  }
  ...
  getPrice(asset_: Address, variant_: i32): PriceV2__getPriceResult {
    const result = super.call(
      "getPrice",
    ...
    return new PriceV2__getPriceResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_getPrice(
    asset_: Address,
    variant_: i32,
  ): ethereum.CallResult<PriceV2__getPriceResult> {
    const result = super.tryCall(
      "getPrice",
      "getPrice(address,uint8):(uint256,uint48)",
      [
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new PriceV2__getPriceResult(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
  ...
  getPriceIn2(
    ...
    return new PriceV2__getPriceIn2Result(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_getPriceIn2(
    ...
    base_: Address,
    variant_: i32,
  ): ethereum.CallResult<PriceV2__getPriceIn2Result> {
    const result = super.tryCall(
      "getPriceIn",
      "getPriceIn(address,address,uint8):(uint256,uint48)",
      [
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new PriceV2__getPriceIn2Result(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
