...
export class RangeV2__VERSIONResult {
  value0: i32;
  value1: i32;
...
export class RangeV2__rangeResultValue0Struct extends ethereum.Tuple {
  get low(): RangeV2__rangeResultValue0LowStruct {
    return changetype<RangeV2__rangeResultValue0LowStruct>(this[0].toTuple());
  }

  get high(): RangeV2__rangeResultValue0HighStruct {
    return changetype<RangeV2__rangeResultValue0HighStruct>(this[1].toTuple());
  }
}

export class RangeV2__rangeResultValue0LowStruct extends ethereum.Tuple {
  get active(): boolean {
  ...
  get cushion(): RangeV2__rangeResultValue0LowCushionStruct {
    return changetype<RangeV2__rangeResultValue0LowCushionStruct>(
      this[5].toTuple(),
    );
  }

  get wall(): RangeV2__rangeResultValue0LowWallStruct {
    return changetype<RangeV2__rangeResultValue0LowWallStruct>(
      this[6].toTuple(),
    );
  }
}

export class RangeV2__rangeResultValue0LowCushionStruct extends ethereum.Tuple {
  get price(): BigInt {
...
export class RangeV2__rangeResultValue0LowWallStruct extends ethereum.Tuple {
  get price(): BigInt {
    return this[0].toBigInt();
  }
...
export class RangeV2__rangeResultValue0HighStruct extends ethereum.Tuple {
  get active(): boolean {
    return this[0].toBoolean();
  }
  ...
  get cushion(): RangeV2__rangeResultValue0HighCushionStruct {
    return changetype<RangeV2__rangeResultValue0HighCushionStruct>(
      this[5].toTuple(),
    );
  }

  get wall(): RangeV2__rangeResultValue0HighWallStruct {
    return changetype<RangeV2__rangeResultValue0HighWallStruct>(
      this[6].toTuple(),
    );
  }
}

export class RangeV2__rangeResultValue0HighCushionStruct extends ethereum.Tuple {
  get price(): BigInt {
    return this[0].toBigInt();
  }
...
export class RangeV2__rangeResultValue0HighWallStruct extends ethereum.Tuple {
  get price(): BigInt {
    return this[0].toBigInt();
  }
...
export class RangeV2 extends ethereum.SmartContract {
  static bind(address: Address): RangeV2 {
    return new RangeV2("RangeV2", address);
  }
  ...
  VERSION(): RangeV2__VERSIONResult {
    const result = super.call("VERSION", "VERSION():(uint8,uint8)", []);

    return new RangeV2__VERSIONResult(result[0].toI32(), result[1].toI32());
  }

  try_VERSION(): ethereum.CallResult<RangeV2__VERSIONResult> {
    ...
    return ethereum.CallResult.fromValue(
      new RangeV2__VERSIONResult(value[0].toI32(), value[1].toI32()),
    );
  }
  ...
  range(): RangeV2__rangeResultValue0Struct {
    const result = super.call(
      "range",
    ...
    return changetype<RangeV2__rangeResultValue0Struct>(result[0].toTuple());
  }

  try_range(): ethereum.CallResult<RangeV2__rangeResultValue0Struct> {
    const result = super.tryCall(
      "range",
      "range():(((bool,uint48,uint256,uint256,uint256,(uint256,uint256),(uint256,uint256)),(bool,uint48,uint256,uint256,uint256,(uint256,uint256),(uint256,uint256))))",
      [],
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<RangeV2__rangeResultValue0Struct>(value[0].toTuple()),
    );
  }
