...
export class PriceV1_1 extends ethereum.SmartContract {
  ...
  cumulativeObs(): BigInt {
    let result = super.call("cumulativeObs", "cumulativeObs():(uint256)", []);
  ...
  getLastPrice(): BigInt {
    let result = super.call("getLastPrice", "getLastPrice():(uint256)", []);

    return result[0].toBigInt();
  }

  try_getLastPrice(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("getLastPrice", "getLastPrice():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getTargetPrice(): BigInt {
    let result = super.call("getTargetPrice", "getTargetPrice():(uint256)", []);
  ...
  nextObsIndex(): BigInt {
    let result = super.call("nextObsIndex", "nextObsIndex():(uint32)", []);

    return result[0].toBigInt();
  }

  try_nextObsIndex(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("nextObsIndex", "nextObsIndex():(uint32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  observations(param0: BigInt): BigInt {
    let result = super.call("observations", "observations(uint256):(uint256)", [
